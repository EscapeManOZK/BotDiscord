...
{var tooltip;
    ...
    {var bound,alternate;
        ...
        if(alternate&&!s.over){
            s.over=true;checkBounds(s,alternate,margin,slide);
        }else{
    ...
    function animateTooltip(s,options,el,fn){
        ...
        tooltip.animate(s.on,{duration:duration,queue:false,complete:fn});
        tooltip.fadeIn(duration);
    }
    function animateTooltipOut(s,options,el,fn){
        var duration=getDefault('duration',options,el,100);
        tooltip.animate(s.off,{duration:duration,queue:false,complete:fn});
    ...
    jQuery.fn.tooltip=function(options){
        ...
        this.each(function(){
            ...
            el.unbind('mouseenter').mouseenter(function(){
                ...
                clearTimeout(timer);
                timer=setTimeout(function(){var margin=getDefault('margin',options,el,20);
    ...
    $(document).ready(function(){
        ...
        win=$(window);arrowWidth=arrow.width();
